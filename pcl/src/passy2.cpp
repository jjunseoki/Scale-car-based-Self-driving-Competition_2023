...
pass.setFilterLimits (0.15, 0.8); // x : -1.0 ~ 1.0
...
{
ros::init(argc, argv, "passthroughy2");
ros::NodeHandle nh;

ros::Subscriber sub = nh.subscribe<sensor_msgs::PointCloud2>("/passx2", 1000, callbackFcn);

pub = nh.advertise<sensor_msgs::PointCloud2>("/passy2", 1000);
ros::spin();
return 0;
}
